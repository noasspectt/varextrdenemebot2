...
module.exports = {
  name: 'capslock-engel',
  description: 'Capslock engelleme sistemini açar veya kapatır.',
  async execute(message, args, settings, saveSettings) {
    ...
    settings.capslockengel = isEnabled;
    saveSettings(settings);

    message.reply(`Capslock engelleme sistemi başarıyla \`${settingValue}\` olarak ayarlandı.`);
  },
};